...
def questionsUpload():
    ...
    jFile= 'C:/Users/headway/PycharmProjects/untitled/db.json'
    jsonFile= 'C:/Users/headway/PycharmProjects/untitled/db_{}.json'.format(backup)
...
def usersUpload():
    ...
    # code pending for taking backup of this json
    jFile = 'C:/Users/headway/PycharmProjects/untitled/users.json'
    jsonFile = 'C:/Users/headway/PycharmProjects/untitled/users_{}.json'.format(backup)
    copyfile(jFile, jsonFile)
...
def chartsOne():
    ...
    df=pd.DataFrame(columns=['sector','subsector','cid','cname','qid','qscore','qconfidence'])
